...
public:
	...
	Dome();
	Dome(string pathTexture, string pathTexture2, string pathTexture3, OpenGLClass* OpenGL, TextureClass* LoaderTextureRef, float radius);
	...
	bool Render(float* viewMatrix, float* projectionMatrix, float time, int opcion);
